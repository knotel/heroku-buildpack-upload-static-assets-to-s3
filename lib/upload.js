...
// app name for heroku review apps
...
if (HEROKU_APP_NAME !== undefined) {
  fs.rename(PUBLIC_ASSETS_SOURCE_DIRECTORY+ '/asset-manifest.json', PUBLIC_ASSETS_SOURCE_DIRECTORY + '/' + HEROKU_APP_NAME + '.json', function(err) {
